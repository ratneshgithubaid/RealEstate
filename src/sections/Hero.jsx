    ...
    <>
      <div className="{`${darkMode ? 'dark bg-black' : 'light bg-white'}`}">
        ...
        >
          ...
          >
            "Step into a world where every property reflects elegance, comfort,
            and sophistication. We bring you homes that don’t just exist—they
            inspire. From waterfront villas to skyline apartments, our listings
            are designed for those who dream big and live bigger."
          </p>
        </section>
      </div>
          ...
          <div className="w-full">
           ...
           <div className="w-full">
            ...
            >
              ...
              <option value="option5">House</option>
            </select>
          </div>
